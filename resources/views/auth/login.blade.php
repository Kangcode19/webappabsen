...
<body class="bg-white">
    ...
    <div id="appCapsule" class="pt-0">
        ...
        <div class="login-form mt-1">
            <div class="section">
                <img src="{{ asset('assets/img/login/jmn.png') }}" alt="image" class="form-image">
            </div>
            <div class="section mt-1">
                <h1>Selamat datang di Wabsite absensi karyawan</h1>
                <h4>Silahkan Login dahulu</h4>
            </div>
            <div class="section mt-1 mb-5">
                ...
                <form action="/proseslogin" method="POST">
                    ...
                    <div class="form-button-group">
                        <button type="submit" class="btn btn-success btn-block btn-lg">Masuk absen</button>
                    </div>
